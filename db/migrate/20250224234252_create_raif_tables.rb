...
class CreateRaifTables < ActiveRecord::Migration[8.0]
  def change
    ...
    json_type = is_postgres ? :jsonb : :json
    ...
    create_table :raif_tasks do |t|
      ...
      t.send(json_type, :available_model_tools)
    ...
    create_table :raif_model_tool_invocations do |t|
      ...
      t.send(json_type, :tool_arguments, default: {}, null: false)
      t.send(json_type, :result, default: {}, null: false)
      t.datetime :completed_at
      t.datetime :failed_at
    ...
    create_table :raif_user_tool_invocations do |t|
      ...
      t.string :type, null: false
      t.send(json_type, :tool_settings, default: {}, null: false)
    ...
    create_table :raif_agent_invocations do |t|
      ...
      t.send(json_type, :conversation_history, default: is_postgres ? [] : "[]", null: false)
    ...
    create_table :raif_model_completions do |t|
      ...
      t.send(json_type, :messages, default: is_postgres ? [] : "[]", null: false)
      t.text :system_prompt
      t.integer :response_format, default: 0, null: false
