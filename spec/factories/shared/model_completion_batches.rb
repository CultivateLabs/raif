...
FactoryBot.define do
  ...
  factory :raif_model_completion_batch_open_ai_responses, class: "Raif::ModelCompletionBatches::OpenAi" do
    llm_model_key { "open_ai_responses_gpt_4o" }
    model_api_name { "gpt-4o" }
    status { "pending" }
  end

  factory :raif_model_completion_batch_open_ai_completions, class: "Raif::ModelCompletionBatches::OpenAi" do
