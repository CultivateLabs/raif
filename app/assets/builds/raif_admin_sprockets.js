...
%o`, message, error2, detail);
  ...
  var judge_config_controller_default = class extends Controller {
  ...
  var select_all_checkboxes_controller_default = class extends Controller {
    ...
    updateCount() {
      ...
      if (this.hasBatchButtonTarget) {
        ...
        this.batchButtonTarget.textContent = count > 0 ? `${this.batchButtonLabelValue} (${count})` : this.batchButtonLabelValue;
      }
    }
  };

  // app/assets/javascript/raif/admin/cost_estimate_controller.js
  var cost_estimate_controller_default = class extends Controller {
  ...
  var COPY_ICON = `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
<path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1v-1z"/>
<path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
</svg>`;
  var CHECK_ICON = `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
<path d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z"/>
  ...
  window.Stimulus = { Controller };
  var application = Application.start();
  application.register("raif--judge-config", judge_config_controller_default);
  application.register("raif--select-all-checkboxes", select_all_checkboxes_controller_default);
  application.register("raif--cost-estimate", cost_estimate_controller_default);
  application.register("raif--tom-select", tom_select_controller_default);
  application.register("raif--copy-to-clipboard", copy_to_clipboard_controller_default);
})();
